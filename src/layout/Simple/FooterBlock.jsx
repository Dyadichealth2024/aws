            ...
            <Grid item xs={12} sm={2}>
              ...
              <Box mt={2}>
                <Link
                  ...
                  color="secondary.main"
                  component="button"
                  onClick={() => handleOpenDialog('Terms & Conditions', 'This is the content for Terms & Conditions.')}
                  underline="none"
                >
                  Terms & Conditions
                </Link>
              ...
              <Box mt={2}>
                <Link
                  ...
                  color="secondary.main"
                  component="button"
                  onClick={() => handleOpenDialog('Privacy Policy', 'This is the content for Privacy Policy.')}
                  underline="none"
                >
                  Privacy Policy
                </Link>
